...
# Find boundaries
idx_togglemenu = c.index("    private void toggleMenu()")
idx_bridge = c.index("    private final class BridgeCallbacks")
idx_channel_class = c.index("    private static final class Channel")
idx_channel_adapter = c.index("    private final class ChannelAdapter")
idx_gesture = c.index("    private final class GestureTraceView")

print(f"toggleMenu={idx_togglemenu}")
print(f"BridgeCallbacks={idx_bridge}")
print(f"Channel class={idx_channel_class}")
print(f"ChannelAdapter={idx_channel_adapter}")
print(f"GestureTraceView={idx_gesture}")

# Keep BridgeCallbacks + Channel class intact
bridge_and_channel = c[idx_bridge:idx_channel_adapter]

# New menu methods + new ChannelAdapter
new_menu_block = """    private void toggleMenu() {
...
new_channel_adapter = """    private final class ChannelAdapter extends BaseAdapter {
