...
print(f"Replacing chars {start_idx} to {end_idx} (length={end_idx-start_idx})")
...
new_content = c[:start_idx] + new_menu_block + c[end_idx:]

with open(filepath, 'w', encoding='utf-8') as f:
    f.write(new_content)

print(f"Menu block replaced. New file size: {len(new_content)}")